...
void preOrder ( TreeNodePtr treePtr )
{
  if(treePtr != NULL)
  {
    printf("%3d",treePtr->data ); //printf myself
...
void printchristmas (TreeNodePtr treePtr,int n )
{
  int i;
  if(treePtr != NULL)
  {
    printchristmas( treePtr->rightPtr,n+1);
  ...
  printf("%d\n",treePtr->data);
  printchristmas( treePtr->leftPtr,n+1 );
    }  
}
